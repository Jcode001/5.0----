...
            $("#sysname").html(sysname)
		...
		function showAuto(){
				...
				indata['jsonin']='{"ip":"'+$('#HostName').html()+'","deviceType":"6","deviceNo":"'+$('#DeviceID').val()+'","startDate": "'+startdate+'","endDate": "'+enddate+'"}';
				//console.log(indata)
...
<div style="position:absolute;right:2%;top:0%;width:80%;height:100%;background-color:#e5eef7;border-radius:12px">
  ...
  <div style="position:absolute;left:24%;top:2%;width:20%;height:50px;">设备编号:
   <select id="DeviceID" style="width:70%;height:100%;border:1px solid #e6eef8;border-radius:6px;outline:none">
	<option value="1#" selected>1号精密空调</option>
  	<option value="2#">2号精密空调</option>
  	<option value="3#">3号精密空调</option>
  	<option value="4#">4号精密空调</option>
  	<option value="5#">5号精密空调</option>
   </select>
  </div>
