			...
			<div
				...
				<div
					...
					<el-button type="primary" size="big"
						@click="devicePage(`/hjjk/wrkfkzq/bgsxfjview/index`)">设备页面</el-button>
					<el-button type="primary" size="big"
						@click="devicePage(`/hjjk/wrkfkzq/bgsxfjview/report`)">数据报表</el-button>
					<el-button type="primary" size="big" @click="devicePage(`/hjjk/wrkfkzq/bgsxfjview/chart`)"
...
export default {
	...
	methods: {
		...
		showAuto() {
			...
			indata['jsonin'] = '{"ip":"' + $('#HostName').html() + '","deviceType":"3","deviceNo":"' + this.DeviceID + '","startDate": "' + startdate + '","endDate": "' + enddate + '"}';
			//console.log(indata)
