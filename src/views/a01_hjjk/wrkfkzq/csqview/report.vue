		...
		<div style="display:flex;">
			...
			<div
				...
				<div
					...
					<el-button type="primary" size="big" @click="devicePage(`/hjjk/wrkfkzq/csqview/index`)">设备页面</el-button>
					<el-button type="primary" size="big" @click="devicePage(`/hjjk/wrkfkzq/csqview/report`)"
				...
				<div style="position:absolute;left:24%;top:2%;width:20%;height:50px;">设备编号:
					<el-select v-model="DeviceID"
						...
						<!-- <el-option value="1#" label="1号除湿机"  selected></el-option>
					<el-option value="2#" label="2号除湿机"  ></el-option>
					<el-option value="3#" label="3号除湿机"  ></el-option>
					<el-option value="4#" label="4号除湿机"  ></el-option>
					<el-option value="5#" label="5号除湿机"  ></el-option>
					<el-option value="6#" label="6号除湿机"  ></el-option>
					<el-option value="7#" label="7号除湿机"  ></el-option>
					<el-option value="8#" label="8号除湿机"  ></el-option>
					<el-option value="9#" label="9号除湿机"  ></el-option>
					<el-option value="10#" label="10号除湿机"  ></el-option>
					<el-option value="11#" label="11号除湿机"  ></el-option>
					<el-option value="12#" label="12号除湿机"  ></el-option> -->
					</el-select>
				</div>
...
export default {
	...
	methods: {
		...
		DA_zaijiedaochu() {
			...
			try {
				FileSaver.saveAs(
					...
					`除湿机${year}${mounth}${day}${hours}${minutes}${seconds}` + ".xlsx"
				);
			} catch (e) {
		...
		showAuto() {
			...
			indata['jsonin'] = '{"ip":"' + $('#HostName').html() + '","deviceType":"6","deviceNo":"' + this.DeviceID + '","startDate": "' + startdate + '","endDate": "' + enddate + '"}';
			//console.log(indata)
