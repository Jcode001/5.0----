		...
		<div style="display:flex;">
			...
			<div
				...
				<div
					...
					<el-button type="primary" size="big" @click="devicePage(`/hjjk/wrkfkzq/hwktview/report`)"
						disabled>数据报表</el-button>
					<el-button type="primary" size="big"
						@click="devicePage(`/hjjk/wrkfkzq/hwktview/chart`)">数据曲线</el-button>
		...
		DA_zaijiedaochu() {
			...
			try {
				FileSaver.saveAs(
					...
					`红外空调${year}${mounth}${day}${hours}${minutes}${seconds}` + ".xlsx"
				);
			} catch (e) {
