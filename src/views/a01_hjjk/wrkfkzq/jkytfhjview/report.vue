			...
			<div
				...
				<div
					...
					<el-button type="primary" size="big"
						@click="devicePage(`/hjjk/wrkfkzq/jkytfhjview/index`)">设备页面</el-button>
					<el-button type="primary" size="big" @click="devicePage(`/hjjk/wrkfkzq/jkytfhjview/report`)"
						disabled>数据报表</el-button>
					<el-button type="primary" size="big"
						@click="devicePage(`/hjjk/wrkfkzq/jkytfhjview/chart`)">数据曲线</el-button>
				...
				<div style="position:absolute;left:24%;top:2%;width:20%;height:50px;">设备编号:
					<el-select v-model="DeviceID"
						...
						<!-- <el-option value="1#" label="1号健康防护一体机"  selected></el-option>
					<el-option value="2#" label="2号健康防护一体机"  ></el-option>
					<el-option value="3#" label="3号健康防护一体机"  ></el-option>
					<el-option value="4#" label="4号健康防护一体机"  ></el-option>
					<el-option value="5#" label="5号健康防护一体机"  ></el-option>
					<el-option value="6#" label="6号健康防护一体机"  ></el-option>
					<el-option value="7#" label="7号健康防护一体机"  ></el-option>
					<el-option value="8#" label="8号健康防护一体机"  ></el-option>
					<el-option value="9#" label="9号健康防护一体机"  ></el-option>
					<el-option value="10#" label="10号健康防护一体机"  ></el-option>
					<el-option value="11#" label="11号健康防护一体机"  ></el-option>
					<el-option value="12#" label="12号健康防护一体机"  ></el-option>
					<el-option value="13#" label="13号健康防护一体机"  ></el-option>
					<el-option value="14#" label="14号健康防护一体机"  ></el-option>
					<el-option value="15#" label="15号健康防护一体机"  ></el-option>
					<el-option value="16#" label="16号健康防护一体机"  ></el-option> -->
					</el-select>
				</div>
...
export default {
	...
	methods: {
		...
		DA_zaijiedaochu() {
			...
			try {
				FileSaver.saveAs(
					...
					`健康防护一体机${year}${mounth}${day}${hours}${minutes}${seconds}` + ".xlsx"
				);
			} catch (e) {
		...
		showAuto() {
			...
			indata['jsonin'] = '{"ip":"' + $('#HostName').html() + '","deviceType":"2","deviceNo":"' + this.DeviceID + '","startDate": "' + startdate + '","endDate": "' + enddate + '"}';
			//console.log(indata)
