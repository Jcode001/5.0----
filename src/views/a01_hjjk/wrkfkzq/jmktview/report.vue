			...
			<div
				...
				<div
					...
					<el-button type="primary" size="big"
						@click="devicePage(`/hjjk/wrkfkzq/jmktview/index`)">设备页面</el-button>
					<el-button type="primary" size="big" @click="devicePage(`/hjjk/wrkfkzq/jmktview/report`)"
						disabled>数据报表</el-button>
					<el-button type="primary" size="big"
						@click="devicePage(`/hjjk/wrkfkzq/jmktview/chart`)">数据曲线</el-button>
				...
				<div style="position:absolute;left:24%;top:2%;width:20%;height:50px;">设备编号:
					<el-select v-model="DeviceID"
						...
						<!-- <el-option value="1#" label="1号精密空调"  selected></el-option>
					<el-option value="2#" label="2号精密空调"  ></el-option>
					<el-option value="3#" label="3号精密空调"  ></el-option>
					<el-option value="4#" label="4号精密空调"  ></el-option>
					<el-option value="5#" label="5号精密空调"  ></el-option>
					<el-option value="6#" label="6号精密空调"  ></el-option>
					<el-option value="7#" label="7号精密空调"  ></el-option>
					<el-option value="8#" label="8号精密空调"  ></el-option>
					<el-option value="9#" label="9号精密空调"  ></el-option>
					<el-option value="10#" label="10号精密空调"  ></el-option>
					<el-option value="11#" label="11号精密空调"  ></el-option>
					<el-option value="12#" label="12号精密空调"  ></el-option>
					<el-option value="13#" label="13号精密空调"  ></el-option>
					<el-option value="14#" label="14号精密空调"  ></el-option>
					<el-option value="15#" label="15号精密空调"  ></el-option>
					<el-option value="16#" label="16号精密空调"  ></el-option> -->
...
export default {
	...
	methods: {
		...
		DA_zaijiedaochu() {
			...
			try {
				FileSaver.saveAs(
					...
					`精密空调${year}${mounth}${day}${hours}${minutes}${seconds}` + ".xlsx"
				);
			} catch (e) {
		...
		showAuto() {
			...
			indata['jsonin'] = '{"ip":"' + $('#HostName').html() + '","deviceType":"9","deviceNo":"' + this.DeviceID + '","startDate": "' + startdate + '","endDate": "' + enddate + '"}';
			//console.log(indata)
