			...
			<div
				...
				<div
					...
					<el-button type="primary" size="big"
						@click="devicePage(`/hjjk/wrkfkzq/sxqtjhjview/index`)">设备页面</el-button>
					<el-button type="primary" size="big" @click="devicePage(`/hjjk/wrkfkzq/sxqtjhjview/report`)"
						disabled>数据报表</el-button>
					<el-button type="primary" size="big"
						@click="devicePage(`/hjjk/wrkfkzq/sxqtjhjview/chart`)">数据曲线</el-button>
				...
				<div style="position:absolute;left:24%;top:2%;width:20%;height:50px;">设备编号:
					<el-select v-model="DeviceID"
						...
						<!-- <el-option value="1#" label="1号酸性气体空气净化机"  selected></el-option>
					<el-option value="2#" label="2号酸性气体空气净化机"  ></el-option>
					<el-option value="3#" label="3号酸性气体空气净化机"  ></el-option>
					<el-option value="4#" label="4号酸性气体空气净化机"  ></el-option>
					<el-option value="5#" label="5号酸性气体空气净化机"  ></el-option>
					<el-option value="6#" label="6号酸性气体空气净化机"  ></el-option>
					<el-option value="7#" label="7号酸性气体空气净化机"  ></el-option>
					<el-option value="8#" label="8号酸性气体空气净化机"  ></el-option>
					<el-option value="9#" label="9号酸性气体空气净化机"  ></el-option>
					<el-option value="10#" label="10号酸性气体空气净化机"  ></el-option>
					<el-option value="11#" label="11号酸性气体空气净化机"  ></el-option>
					<el-option value="12#" label="12号酸性气体空气净化机"  ></el-option> -->
					</el-select>
...
export default {
	...
	methods: {
		...
		DA_zaijiedaochu() {
			...
			try {
				FileSaver.saveAs(
					...
					`酸性气体空气净化机${year}${mounth}${day}${hours}${minutes}${seconds}` + ".xlsx"
				);
			} catch (e) {
		...
		showAuto() {
			...
			indata['jsonin'] = '{"ip":"' + $('#HostName').html() + '","deviceType":"4","deviceNo":"' + this.DeviceID + '","startDate": "' + startdate + '","endDate": "' + enddate + '"}';
			//console.log(indata)
