    ...
    <el-container style="height: 100%; border: 1px solid #eee">
            ...
            <div style="display:flex;">
					<div style="position:absolute;right:2%;top:0%;width:98%;height:100%;background-color:#e5eef7;border-radius:12px">
						...
						<el-button type="primary" size="big" disabled>数据曲线</el-button>
						...
						<div class="pieChart" id="temperatureHumidity" ref="temperatureHumidity" style="position:absolute;left:3%;top:11%;width:94%;height:83%;"></div>
...
export default {
   ...
   mounted() {
		...
		this.deviceInformation()
            ...
            // console.log(this.$route.params.id,'当前路由是什么哈哈哈哈');
            console.log(this.$route.path,'当前路由是什么哈哈哈哈');
