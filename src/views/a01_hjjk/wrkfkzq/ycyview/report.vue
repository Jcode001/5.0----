		...
		<div style="display:flex;">
			...
			<div
				...
				<div
					...
					<el-button type="primary" size="big" @click="devicePage(`/hjjk/wrkfkzq/ycyview/index`)">设备页面</el-button>
					<el-button type="primary" size="big" @click="devicePage(`/hjjk/wrkfkzq/ycyview/report`)"
				...
				<div style="position:absolute;left:24%;top:2%;width:20%;height:50px;">设备编号:
					<el-select v-model="DeviceID"
						...
						<!-- <el-option value="1#" label="1号空气质量云测仪"  selected></el-option>
					<el-option value="2#" label="2号空气质量云测仪"  ></el-option>
					<el-option value="3#" label="3号空气质量云测仪"  ></el-option>
					<el-option value="4#" label="4号空气质量云测仪"  ></el-option>
					<el-option value="5#" label="5号空气质量云测仪"  ></el-option>
					<el-option value="6#" label="6号空气质量云测仪"  selected></el-option>
					<el-option value="7#" label="7号空气质量云测仪"  ></el-option>
					<el-option value="8#" label="8号空气质量云测仪"  ></el-option>
					<el-option value="9#" label="9号空气质量云测仪"  ></el-option>
					<el-option value="10#" label="10号空气质量云测仪"  ></el-option>
					<el-option value="11#" label="11号空气质量云测仪"  selected></el-option>
					<el-option value="12#" label="12号空气质量云测仪"  ></el-option>
					<el-option value="13#" label="13号空气质量云测仪"  ></el-option>
					<el-option value="14#" label="14号空气质量云测仪"  ></el-option>
					<el-option value="15#" label="15号空气质量云测仪"  ></el-option> -->
					</el-select>
				</div>
		...
		DA_zaijiedaochu() {
			...
			try {
				FileSaver.saveAs(
					...
					`空气质量云测仪${year}${mounth}${day}${hours}${minutes}${seconds}` + ".xlsx"
				);
			} catch (e) {
