      ...
      >
        ...
        >
          <el-button
            type="primary"
            size="big"
            @click="devicePage(`/hjjk/wrkfkzq/ytjview/index`)"
            >设备页面</el-button
          >
          <el-button
            type="primary"
            size="big"
            @click="devicePage(`/hjjk/wrkfkzq/ytjview/report`)"
            >数据报表</el-button
          >
          <el-button
            type="primary"
            size="big"
            @click="devicePage(`/hjjk/wrkfkzq/ytjview/chart`)"
            disabled
            >数据曲线</el-button
          >
          <el-select
...
export default {
  ...
  methods: {
      ...
      axios
        ...
        .then(
          (success) => {
            ...
            let device = Object.keys(
              success.data.data.devices.CSXJSCSYTJ
            ).length;
    ...
    showlist() {
      ...
      if (DeviceType == 11) this.devicePage("/hjjk/wrkfkzq/ddclview/chart");
