			...
			<div
				...
				<div
					...
					<el-button type="primary" size="big"
						@click="devicePage(`/sfgz/wrkfkzq/gz_fdview/index`)">设备页面</el-button>
					<el-button type="primary" size="big" @click="devicePage(`/sfgz/wrkfkzq/gz_fdview/report`)"
		...
		DA_zaijiedaochu() {
			...
			try {
				FileSaver.saveAs(
					...
					`防盗报警器${year}${mounth}${day}${hours}${minutes}${seconds}` + ".xlsx"
				);
			} catch (e) {
