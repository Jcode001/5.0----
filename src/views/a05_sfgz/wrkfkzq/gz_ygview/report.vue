            ...
            <div
                ...
                <div
                    ...
                    <el-button type="primary" size="big"
                        @click="devicePage(`/sfgz/wrkfkzq/gz_ygview/index`)">设备页面</el-button>
                    <el-button type="primary" size="big" @click="devicePage(`/sfgz/wrkfkzq/gz_ygview/report`)"
                ...
                <div style="position:absolute;left:4%;top:2%;width:20%;height:50px;">设备类型:
                    <el-select v-model="DeviceType"
                        ...
                        <!-- <el-option label="环境超限专用报警器" value="4" ></el-option>
							...
							<el-option label="烟感报警器" value="15" selected></el-option>
                ...
                <div style="position:absolute;left:24%;top:2%;width:20%;height:50px;">设备编号:
                    <el-select id="DeviceID" v-model="DeviceID"
                        ...
                        <!-- <el-option label="1号烟感报警器" value="0" selected></el-option>
							<el-option label="2号烟感报警器" value="1" ></el-option>
							<el-option label="3号烟感报警器" value="2" ></el-option>
							<el-option label="4号烟感报警器" value="3"></el-option>
							<el-option label="5号烟感报警器" value="4"></el-option>
							<el-option label="6号烟感报警器" value="5"></el-option>
							<el-option label="7号烟感报警器" value="6"></el-option>
							<el-option label="8号烟感报警器" value="7"></el-option>
                            <el-option label="9号烟感报警器" value="8" ></el-option>
							<el-option label="10号烟感报警器" value="9" ></el-option>
							<el-option label="11号烟感报警器" value="10"></el-option>
							<el-option label="12号烟感报警器" value="11"></el-option>
							<el-option label="13号烟感报警器" value="12"></el-option>
							<el-option label="14号烟感报警器" value="13"></el-option>
							<el-option label="15号烟感报警器" value="14"></el-option>
                            <el-option label="16号烟感报警器" value="15"></el-option> -->
                    </el-select>
                </div>
...
export default {
    ...
    methods: {
        ...
        DA_zaijiedaochu() {
            ...
            try {
                FileSaver.saveAs(
                    ...
                    `烟感报警器${year}${mounth}${day}${hours}${minutes}${seconds}` + ".xlsx"
                );
            } catch (e) {
        ...
        deviceInformation() {
            ...
            axios.get("http://" + this.ServeIp + ":" + this.ServePort + `/settingDeviceShow/getAll?warehouseId=${sessionStorage.getItem("StoreId")}&controllerId=${sessionStorage.getItem("ACId")}`).then(
                success => {
                    ...
                    let device = Object.keys(success.data.data.devices.YGMK).length;
                    for (let i = 1; i < device + 1; i++) {
                        let deviceFacility = success.data.data.devices.YGMK[i];
        ...
        showAuto() {
            ...
            indata['jsonin'] = '{"ip":"' + $('#HostName').html() + '","deviceType":"15","deviceNo":"' + this.DeviceID + '#","startDate": "' + startdate + '","endDate": "' + enddate + '"}';
            //console.log(indata)
...
<head>
    ...
    <script>
        ...
        siren = "烟感预警器";
        awacs = "防火预警";
        interfase = "UnmannedKFPTService/getBJQSJBySpecific";
        ...
        $(function () {
            ...
            $("#btnexport").bind("click", function () {
                ...
                var url = "/unmanned/fh/exportToExcel9";
                ...
                params['urlpath'] = "/UnmannedKFPTService/getBJQSJBySpecific";
                if (startdate != '' && enddate != '') {
                    startdate += ':00';
                    enddate += ':00';
                }
                params['requestParams'] = '{"ip": "' + HostName + '","deviceType": "15","deviceNo": "' + classifyList[index_One].arr[num].deviceSerialNumber + '#","startDate": "' + startdate + '","endDate": "' + enddate + '"}';
        ...
        $(document).ready(function () { //删除数据 start
            $("#empty-qr").click(function () {
                ...
                indata['jsonin'] = '{"ip":"' + HostName + '","type":"15"}';
                //console.log(indata)
                console.log(JSON.stringify(indata))
                $.ajax({
                    type: "POST",
    ...
    <script src="/bfgz/wrkfkzq/gz_fdview/js/publicFunction.js"></script>
</head>

<body style="margin:0;padding:0">
    <div style="position:absolute;left:0%;top:0%;width:100%;height:100%;background-color:#023580"></div>
    <div
    ...
    <div style="position:absolute;right:2%;top:13%;width:80%;height:82%;background-color:#e5eef7;border-radius:12px">
        ...
        <div
            ...
            <a href="/twelvePrevent/toDevice?pageName=wrkfkzq/gz_ygview"><button
