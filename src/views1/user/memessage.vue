    ...
    <div style="width:100%;height:100vh">
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline" >
            <el-form-item>
                ...
                <el-input v-model="formInline.nickNamelist" style="width:10vw;" placeholder="请输入类型"></el-input>
            </el-form-item>
            <el-form-item>
                <span>状态：</span>
                <el-input v-model="formInline.nickNamelist" style="width:10vw;" placeholder="请输入状态"></el-input>
            </el-form-item>
            <el-form-item style="">
                <el-date-picker
                    v-model="value2"
        ...
        <el-table-column prop="describe" label="内容"  align="center"> </el-table-column>
        <el-table-column  prop="time" label="请求时间" align="center" > </el-table-column>
    ...
    data() {
        return {
          ...
          label: 'POST'
            ...
            tableData: [{
                describe: '获取当前登录用户信息失败[com.induo.archivemanagement.framework.exceot',
                state: '失败',
                type: 'ohter',
